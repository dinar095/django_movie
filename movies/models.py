...
class Actor(models.Model):
    ...
    description = models.TextField("Описание")
    image = models.ImageField("Имя", upload_to="actors/")
...
class Movie(models.Model):
    ...
    actors = models.ManyToManyField(Actor, verbose_name="Режиссер", related_name="film_actor")
...
class Reviews(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name="фильм", on_delete=models.CASCADE)
